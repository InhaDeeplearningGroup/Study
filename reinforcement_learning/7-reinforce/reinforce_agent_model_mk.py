...
class ReinforceAgent:
    ...
    def build_model(self):
        # change learning rate : 0.001 -> 0.005
        # add Dense layer
        # change activation function : relu -> elu
        model = Sequential()
...
if __name__ == "__main__":
    ...
    for e in range(EPISODES):
        ...
        if e % 100 == 0:
            ...
            pylab.savefig("./save_graph/reinforce_custom_model.png")
            agent.model.save_weights("./save_model/reinforce_custom_model.h5")
