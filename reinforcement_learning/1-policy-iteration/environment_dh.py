...
class GraphicDisplay(tk.Tk):
    def __init__(self, agent):
        ...
        self.text_reward(2, 2, "R : 2.0")
        self.text_reward(1, 2, "R : -1.0")
        self.text_reward(2, 1, "R : -1.0")
        self.text_reward(3, 1, "R : -0.5")  # new :)
    ...
    def _build_canvas(self):
        ...
        canvas.create_image(150, 350, image=self.shapes[1])  # new triangle :)
...
class Env:
    def __init__(self):
        ...
        self.reward[2][2] = 2  # (2,2) 좌표 동그라미 위치에 보상 1
        self.reward[1][2] = -1  # (1,2) 좌표 세모 위치에 보상 -1
        self.reward[2][1] = -1  # (2,1) 좌표 세모 위치에 보상 -1
        self.reward[3][1] = -0.5  # (3,1) 좌표 세모 위치에 보상 -0.5  new :)
        self.all_state = []
