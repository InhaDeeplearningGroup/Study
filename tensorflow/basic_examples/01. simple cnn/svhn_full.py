...
tf.app.flags.DEFINE_string('data_dir', './dataset/svhn_full/', "save directory of dataset")
...
def maybe_download_and_extract():
    ...
    if not os.path.exists(filepath_train_mat) or not os.path.exists(filepath_test_mat):
        ...
        urllib.request.urlretrieve(URL_TRAIN, filepath_train_mat, _progress)
        urllib.request.urlretrieve(URL_TEST, filepath_test_mat, _progress)
